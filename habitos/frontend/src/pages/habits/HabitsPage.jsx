...
const HabitsPage = () => {
  ...
  // Filter habits based on search term and category
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <button onClick={fetchHabits} className="btn-primary">
            Try Again
          </button>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <DeleteConfirmModal
        ...
        title="Delete Habit"
        message={`Are you sure you want to delete "${deletingHabit?.title}"? This action cannot be undone and will also delete all associated check-ins and progress data.`}
      />
    </div>
  );
};
